...
const fulfillOrders = async(rpc,api,token1Contract,token1Sym,token2Contract,orderBalance,orderPrice,crtlmt)=>{
    ...
    open(api, limtContract, butlerWallet,token1Contract,token1Sym,butlerWallet)
    transfer(api, limtContract, token1Contract, butlerWallet, orderBalance).catch(e => console.log(e));
    crtlmt(api, limtContract, butlerWallet,token2Contract,token1Contract, orderPrice,orderBalance).then(data => {
